...
public class SoundMonstrosityMusic extends TickableSound {
    ...
    public SoundMonstrosityMusic(Netherite_Monstrosity_Entity monstrosity) {
        super(ModSounds.MONSTROSITY_MUSIC.get(), SoundCategory.RECORDS);
        this.Monstrosity = monstrosity;
        this.attenuationType = AttenuationType.NONE;
        this.repeat = true;
        this.repeatDelay = 0;
        this.priority = true;
        this.x = this.Monstrosity.getPosX();
        this.y = this.Monstrosity.getPosY();
        this.z = this.Monstrosity.getPosZ();
    }

    public boolean shouldPlaySound() {
        return !this.Monstrosity.isSilent() && ClientProxy.MONSTROSITY_SOUND_MAP.get(this.Monstrosity.getEntityId()) == this;
    }
    ...
    public void tick() {
        ...
        if (!this.Monstrosity.removed && this.Monstrosity.isAlive()) {
            this.volume = 1;
            this.pitch = 1;
            this.x = this.Monstrosity.getPosX();
            this.y = this.Monstrosity.getPosY();
            ...
            this.finishPlaying();
            ClientProxy.MONSTROSITY_SOUND_MAP.remove(Monstrosity.getEntityId());
        }
        ticksExisted++;
    }
