...
public class ModelNetherite_Monstrosity extends AdvancedEntityModel<Netherite_Monstrosity_Entity> {
	...
	@Override
	public void setRotationAngles(Netherite_Monstrosity_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
