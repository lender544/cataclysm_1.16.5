...
public class ModelIgnited_Revenant extends AdvancedEntityModel<Ignited_Revenant_Entity> {
	...
	public ModelIgnited_Revenant() {
		...
		right_horn.setRotationPoint(-4.0F, -7.5F, -3.5F);
		...
		left_horn.setRotationPoint(4.3F, -7.5F, -3.5F);
		...
		right_parts.setRotationPoint(-3.5F, 2.0F, -12.5F);
		...
		left_parts.setRotationPoint(3.5F, 2.0F, -12.5F);
		...
		spike_right.setRotationPoint(4.0F, 4.5F, -14.0F);
		...
		spike_left.setRotationPoint(-4.0F, 4.5F, -14.0F);
		...
		shield3.setRotationPoint(0.0F, 0.0F, 0.0F);
		...
		right_parts3.setRotationPoint(-3.5F, 2.0F, -12.5F);
		...
		left_parts3.setRotationPoint(3.5F, 2.0F, -12.5F);
		...
		spike_right3.setRotationPoint(4.0F, 4.5F, -14.0F);
		...
		spike_left3.setRotationPoint(-4.0F, 4.5F, -14.0F);
		...
		shield4.setRotationPoint(0.0F, 0.0F, 0.0F);
		...
		right_parts4.setRotationPoint(-3.5F, 2.0F, -12.5F);
		...
		left_parts4.setRotationPoint(3.5F, 2.0F, -12.5F);
		...
		spike_right4.setRotationPoint(4.0F, 4.5F, -14.0F);
		...
		spike_left4.setRotationPoint(-4.0F, 4.5F, -14.0F);
		...
		shield2.setRotationPoint(0.0F, 0.0F, 0.0F);
		...
		right_parts2.setRotationPoint(-3.5F, 2.0F, -12.5F);
		...
		left_parts2.setRotationPoint(3.5F, 2.0F, -12.5F);
		...
		spike_right2.setRotationPoint(4.0F, 4.5F, -14.0F);
		...
		spike_left2.setRotationPoint(-4.0F, 4.5F, -14.0F);
	...
	@Override
	public void setRotationAngles(Ignited_Revenant_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		this.shield.rotationPointY += MathHelper.cos(ageInTicks * 0.1F);
		this.shield4.rotationPointY += MathHelper.cos(ageInTicks * 0.1F);
		this.shield2.rotationPointY -= MathHelper.cos(ageInTicks * 0.1F);
		this.shield3.rotationPointY -= MathHelper.cos(ageInTicks * 0.1F);
