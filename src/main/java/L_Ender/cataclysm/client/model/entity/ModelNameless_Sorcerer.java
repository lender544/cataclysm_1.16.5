...
public class ModelNameless_Sorcerer extends AdvancedEntityModel<Nameless_Sorcerer_Entity> {
    ...
    @Override
    public void setRotationAngles(Nameless_Sorcerer_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
