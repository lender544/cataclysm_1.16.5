...
public class Modspawnegg extends SpawnEggItem {
    ...
    public Modspawnegg(final NonNullSupplier<? extends EntityType<?>> entityTypeSupplier, final int primaryColour,
    ...
    public Modspawnegg(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColour,
                           final int secondaryColour, final Properties properties) {
        super(null, primaryColour, secondaryColour, properties);
        this.entityTypeSupplier = Lazy.of(entityTypeSupplier::get);
        UNADDED_EGGS.add(this);
